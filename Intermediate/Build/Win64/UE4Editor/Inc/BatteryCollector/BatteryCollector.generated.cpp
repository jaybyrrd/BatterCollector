...
FName BATTERYCOLLECTOR_WasCollected = FName(TEXT("WasCollected"));
	...
	IMPLEMENT_CLASS(ABatteryCollectorCharacter, 1228912115);
	void ABatteryCollectorGameMode::StaticRegisterNativesABatteryCollectorGameMode()
	{
	}
	IMPLEMENT_CLASS(ABatteryCollectorGameMode, 485821608);
	...
	IMPLEMENT_CLASS(APickup, 3400342558);
	void ABatteryPickup::StaticRegisterNativesABatteryPickup()
	{
	}
	IMPLEMENT_CLASS(ABatteryPickup, 989263508);
	...
	IMPLEMENT_CLASS(ASpawnVolume, 2273792878);
...
// Cross Module References
	...
	UFunction* Z_Construct_UFunction_ABatteryCollectorCharacter_CollectPickups()
	{
		...
		if (!ReturnFunction)
		{
			...
			MetaData->SetValue(ReturnFunction, TEXT("ToolTip"), TEXT("This function collects the pickups overlapping the CollectionSphere"));
#endif
		}
	...
	UFunction* Z_Construct_UFunction_ABatteryCollectorCharacter_GetCurrentPower()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("GetCurrentPower"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x54020401, 65535, sizeof(BatteryCollectorCharacter_eventGetCurrentPower_Parms));
	...
	UFunction* Z_Construct_UFunction_ABatteryCollectorCharacter_GetInitialPower()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("GetInitialPower"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x54020401, 65535, sizeof(BatteryCollectorCharacter_eventGetInitialPower_Parms));
	...
	UFunction* Z_Construct_UFunction_ABatteryCollectorCharacter_UpdatePower()
	{
		...
		if (!ReturnFunction)
		{
			...
			MetaData->SetValue(ReturnFunction, TEXT("Category"), TEXT("Power"));
			MetaData->SetValue(ReturnFunction, TEXT("ModuleRelativePath"), TEXT("BatteryCollectorCharacter.h"));
			MetaData->SetValue(ReturnFunction, TEXT("ToolTip"), TEXT("@param PowerChange The amount to change CharacterPower by."));
#endif
		}
		return ReturnFunction;
	}
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_ABatteryCollectorCharacter_CollectPickups(), "CollectPickups"); // 1105889435
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_ABatteryCollectorCharacter_GetCurrentPower(), "GetCurrentPower"); // 2262838395
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_ABatteryCollectorCharacter_GetInitialPower(), "GetInitialPower"); // 3712365020
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_ABatteryCollectorCharacter_PowerChangeEffect(), "PowerChangeEffect"); // 3092596302
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_ABatteryCollectorCharacter_UpdatePower(), "UpdatePower"); // 1857297404
				...
				MetaData->SetValue(NewProp_BaseSpeed, TEXT("ToolTip"), TEXT("Initial speed before power mod"));
				...
				MetaData->SetValue(NewProp_SpeedFactor, TEXT("ToolTip"), TEXT("Speed after power mod"));
				...
				MetaData->SetValue(NewProp_InitialPower, TEXT("ToolTip"), TEXT("Initial power level"));
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				...
				MetaData->SetValue(NewProp_DecayRate, TEXT("ToolTip"), TEXT("This rate at which the character loses power"));
#endif
			}
		}
		check(OuterClass->GetClass());
	...
	UFunction* Z_Construct_UFunction_APickup_IsActive()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("IsActive"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x54020401, 65535, sizeof(Pickup_eventIsActive_Parms));
	...
	UFunction* Z_Construct_UFunction_APickup_SetActive()
	{
		...
		if (!ReturnFunction)
		{
			...
			MetaData->SetValue(ReturnFunction, TEXT("Category"), TEXT("Pickup"));
			MetaData->SetValue(ReturnFunction, TEXT("ModuleRelativePath"), TEXT("Pickup.h"));
			MetaData->SetValue(ReturnFunction, TEXT("ToolTip"), TEXT("Allows other classes to safely change the pickup active status"));
#endif
		}
		return ReturnFunction;
	}
	UFunction* Z_Construct_UFunction_APickup_WasCollected()
	{
		...
		if (!ReturnFunction)
		{
			...
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnFunction, TEXT("ModuleRelativePath"), TEXT("Pickup.h"));
			MetaData->SetValue(ReturnFunction, TEXT("ToolTip"), TEXT("Function to call when a pickup is collected"));
#endif
		}
		return ReturnFunction;
	}
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_APickup_IsActive(), "IsActive"); // 1019560932
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_APickup_SetActive(), "SetActive"); // 2106551824
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_APickup_WasCollected(), "WasCollected"); // 3936924393
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	UFunction* Z_Construct_UFunction_ASpawnVolume_GetRandomPointInVolume()
	{
		...
		if (!ReturnFunction)
		{
			...
			MetaData->SetValue(ReturnFunction, TEXT("ToolTip"), TEXT("Returns a random point in the volume"));
#endif
		}
		return ReturnFunction;
	}
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				...
				UProperty* NewProp_SpawnDelayMaximum = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("SpawnDelayMaximum"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(SpawnDelayMaximum, ASpawnVolume), 0x0020080000000005);
				UProperty* NewProp_SpawnDelayMinimum = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("SpawnDelayMinimum"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(SpawnDelayMinimum, ASpawnVolume), 0x0020080000000005);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_ASpawnVolume_GetRandomPointInVolume(), "GetRandomPointInVolume"); // 37528141
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
				...
				MetaData->SetValue(NewProp_SpawnDelayMaximum, TEXT("Category"), TEXT("Spawning"));
				MetaData->SetValue(NewProp_SpawnDelayMaximum, TEXT("ModuleRelativePath"), TEXT("SpawnVolume.h"));
				MetaData->SetValue(NewProp_SpawnDelayMaximum, TEXT("ToolTip"), TEXT("Maximum spawn delay"));
				MetaData->SetValue(NewProp_SpawnDelayMinimum, TEXT("Category"), TEXT("Spawning"));
				MetaData->SetValue(NewProp_SpawnDelayMinimum, TEXT("ModuleRelativePath"), TEXT("SpawnVolume.h"));
				MetaData->SetValue(NewProp_SpawnDelayMinimum, TEXT("ToolTip"), TEXT("Minimum spawn delay"));
